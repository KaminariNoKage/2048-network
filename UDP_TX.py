...
import Socket_App as CN_Sockets # CN_Sockets adds ability to interrupt "while True" loop with ctl-C
...
"""
    ...
    def __init__(self,Server_Address=("192.168.65.1",20)):   # create a socket instance.
